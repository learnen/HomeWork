...
<style type="text/css">
  ...
  <body>
    ...
    <form action="../../../bookshop/adminBook?method=add" method="post" enctype="multipart/form-data">
    	...
    	图书分类：<select style="width: 150px; height: 20px;" name="cid">
			<c:forEach items="${requestScope.categories}" var="category" begin="0" step="1" end="${requestScope.categories.size()}">
