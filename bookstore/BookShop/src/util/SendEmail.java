...
public class SendEmail {
	...
	private String sendAddr = "onlywd123";//这是发送方的邮箱
	private String receiveAddr = "1327316668";//接收方的邮箱

	//这个不是密码,是开启163邮箱第三方登录时候设置的授权码
	//如果不开启,那么是无法第三方登录163邮箱账号的
	private String pass = "a1372892517";
...
//		msg.setRecipients(Message.RecipientType.BCC,"偷偷的发@163.com");
		...
		//添加主题
		msg.setSubject("这是验证邮箱");



		//添加内容,第二个参数表示这是html的内容
		msg.setContent("<html><head ><meta charset='utf-8'>"
				+ "</head><body>内容：为了保证您的 悟空云 帐户的安全，请验证您的电子邮件地址。<br>"
				+ "<a href='http://192.168.20.243:8080/bookshop/email?code="+user.getCode()+"'>点击此处来验证您的电子邮件地址。</a><br>" +
